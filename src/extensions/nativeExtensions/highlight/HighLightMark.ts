import HighlightOriginal  from './highlight.js'
...
export default class Bold extends AbstractExtension {
  constructor (options) {
    super(options, HighlightOriginal)
  }
    ...
    return [
      {
        render: new ExtensionActionRenderBtn({
          tooltip: new I18nText('extensions.HighLight.buttons.bold.tooltip'),
          icons: {
            [VuetifyIconsGroups.md]: new VuetifyIcon('format_bold'),
            [VuetifyIconsGroups.fa]: new VuetifyIcon('fas fa-bold'),
            [VuetifyIconsGroups.mdi]: new VuetifyIcon('mdi-fountain-pen-tip'),
